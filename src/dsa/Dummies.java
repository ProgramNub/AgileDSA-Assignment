...
//
//        flowers.add(new Product("F001",'F',"Rose",11,10.00,"Colour:Pink,Red,White",20,11));
//        flowers.add(new Product("F002",'F',"Orkid",11,10.00,"Orhid colour:red blue purple",20,12));
//        flowers.add(new Product("F003",'F',"Sun Flower",11,10.00,"Colour Yellow",0,0));
//        
//        return flowers;
//    }
//    
...
//
//        bouquets.add(new Product("B001",'B',"WEDDING",11,60.00,"Colour Yellow",0,0));
//        bouquets.add(new Product("B002",'B',"NEW BORN",11,60.00,"Colour: Pink,Red",0,0));
//
//        return bouquets;
//    }
...
public static ListInterface<Product> ProductList(ListInterface<Product> products) {
        ...
        products.add(new Product("F002",'F',"Orkid",11,10.00,"Orhid colour:red blue",20,12));
