...
public class MainMenu {
    ...
    //    main(products, corporates, consumers, items, orders);
        ...
        */
        main(products, products, items, products, corporates, consumers, items, orders);
                }
    
   public static void main(ListInterface<Product> products,ListInterface<Product> flowers, ListInterface<Item> realItems,ListInterface<Product> bouquets, ListInterface<Corporate> corporates,ListInterface<Consumer> consumers, ListInterface<Item> items,  ListInterface<Order> orders){
