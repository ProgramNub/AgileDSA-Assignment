...
public class ListDummies {
    ...
    public static ListInterface<Product> ProductList() {
        ListInterface<Product> products = new LinkedList<>();

        products.add(new Product("F001",'F',"Rose",11,10.00,"Colour:Pink,Red,White"));
        products.add(new Product("F002",'F',"Orkid",11,10.00,"Orhid colour:red blue purple"));
        products.add(new Product("F003",'F',"Sun Flower",11,10.00,"Colour Yellow"));
        products.add(new Product("B001",'B',"WEDDING",11,60.00,"Colour Yellow"));
        products.add(new Product("B002",'B',"NEW BORN",11,60.00,"Colour: Pink,Red"));
