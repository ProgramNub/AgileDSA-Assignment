...
//            System.out.print("Please enter option: ");
            ...
            if (type.equals("1")) {
                updateFlower(products);
            } else if (type.equals("2")) {
                updateBouquet(products);
    ...
    public static void updateFlower(ListInterface<Product> products) {
        int ans = 0;
        String id = "";
        int count = 0;
    ...
    public static void updateBouquet(ListInterface<Product> products) {
        int ans = 0;
        String id = "";
        int count = 0;
        DisplayList.displayFlowerList(products);
