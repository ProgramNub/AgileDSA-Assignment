...
public class Item {
    ...
    public Item(String itemID, String itemName, char type, double unitPrice, int quantityBought, String OrderID) {
        this.itemID = itemID;
    ...
    public boolean corpCredit(boolean paid, Corporate corp, double productTtlPrice){
